...
-e dir1,dir2..  Exclude the list of directories from being parsed"""
...
def main(argv=None):
    ...
    try:
        opts, args = getopt.getopt(argv[1:], "DRSVe:f:i:", ["exclude-dirs="])
    ...
    for o, a in opts:
        ...
        if o in ("-e", "--exclude-dirs"):
            exclude_dirs = a.split(',')
