...
__date__ = "2013/03/16"
__version__ = "1.2.1"
__usage__ = """Usage: pycscope.py [-D] [-R] [-S] [-V] [-f reffile] [-i srclistfile] [-e dir1,dir2...] [files ...]
...
-e dir1,dir2..  Exclude the list of paths from being parsed"""
...
def main(argv=None):
    ...
    # exclude list should contain absolute path. This is because:
    # If dir/file named "test" in root of source repo is excluded, we do not
    # want path such as "a/b/test" to be excluded as well.
    exclude = [os.path.normpath(os.path.join(basepath, directory))
